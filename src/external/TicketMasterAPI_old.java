...
public class TicketMasterAPI_old {
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s&size=20", API_KEY, geoHash, keyword, 50);
//		String query = String.format("apikey=%s&latlong=%s,%s&keyword=%s&radius=%s&size=20", API_KEY, lat, lon, keyword, 50);
	...
	public static void main(String[] args) {
		...
		TicketMasterAPI_old tmApi = new TicketMasterAPI_old();
		// Mountain View, CA
